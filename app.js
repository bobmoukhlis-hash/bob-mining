...
if (
    ...
    alert(
        "Il Daily Bonus è già stato ricevuto."
    );
...
if (minerLevel < 2) {
    ...
    alert(
        "Raggiungi almeno il Livello 2 per ricevere questo Reward."
    );
...
if (
    ...
    alert(
        "❌ Servono " +
        cost.toFixed(2) +
        " BOB Points per il prossimo upgrade."
    );
